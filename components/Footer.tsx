  ...
  return (
    <footer className="border-t border-white/10 pb-[env(safe-area-inset-bottom)]">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-5 px-5 py-10 sm:gap-6 sm:px-6 sm:py-12">
        <nav className="flex w-full max-w-sm flex-wrap items-center justify-center gap-x-1 sm:hidden">
          <a
            href="#musicas"
            className="px-3 py-2 text-[11px] uppercase tracking-[0.18em] text-white/50"
          >
            Músicas
          </a>
          <a
